...
/*        bestScore = PlayerPrefs.GetInt("BestScoreQuiz");
        ...
        string levelKey = "BestScoreQuizLevel" + SceneManager.GetActiveScene().buildIndex;
        bestScore = PlayerPrefs.GetInt(levelKey);
        bestDisplay.GetComponent<TextMeshProUGUI>().text = "BEST: " + bestScore;
    }
    ...
    private void Update()
    {
        ...
        if (QuestionGenerate.shouldExecute == false)
        {
...
/*        if(bestScore < scoreValue)
        ...
        if (bestScore < scoreValue)
        {
            PlayerPrefs.SetInt(levelKey, scoreValue);
            bestScore = scoreValue;
            bestDisplay.GetComponent<TextMeshProUGUI>().text = "BEST: " + scoreValue;
        }
